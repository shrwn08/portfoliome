        ...
        <div className="hero-inner">
          <div>
            <div className="hero-badge">
              <span className="hero-badge-dot"></span>Full Stack Developer
            </div>
            <h1>
              Building Scalable
              <br />
              Web Applications
              <br />
              <span className="line2">That Solve Problems.</span>
            </h1>
            <p className="hero-desc">
              I build end-to-end MERN stack applications with clean UI, robust
              backend, and optimal performance. MBA background sharpens my
              product thinking.
            </p>
            ...
            <div className="hero-socials">
              ...
              <a
                href="mailto:shrwnkumar08@gmail.com"
                className="social-btn"
                title="Email"
              >
                <svg
